...
| Cursor | Native and portable local bundles writable through intact vault/restore; marketplace installs read-only | Marketplace installs inventoried read-only |
...
| Cursor | Unsupported; local native and portable manifests are inventoried, but no package activation reference is supported | Unsupported; no fixture-backed standard package root |
