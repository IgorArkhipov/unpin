...
pub(crate) fn plan_directory_toggle(app_state_root: PathBuf, item: DiscoveryItem) -> ToggleResult {
...
pub(crate) fn apply_directory_toggle(
...
pub(crate) fn apply_disabled_directory_toggle(
    app_state_root: PathBuf,
    item: DiscoveryItem,
    backup_authentication_key: &BackupAuthenticationKey,
) -> ToggleResult {
